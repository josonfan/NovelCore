...
class PushToElastic extends Command
{
    ...
    private function getDataToPush(): array
    {
        ...
        $list =  $model->where('updated_at', '>', $lastSyncTime)->field('id,title,author_id,category_id,intro,is_r18,is_vip,like_count,fav_count,view_count,status,updated_at')->limit(1)->select()->toArray();
