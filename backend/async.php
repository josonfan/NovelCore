...
$uniExecMethods = [];
$uniExecMethods['video_async_exec_method_custom'] = '自定义异步执行队列';
$uniExecMethods['uni_exec_method_custom'] = '自定义异步执行队列';
for ($i = 1; $i <= 5; $i++) {
    $uniExecMethods['uni_exec_method_custom' . $i] = '自定义异步执行队列';
}
